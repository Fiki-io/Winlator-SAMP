...
public class GuestProgramLauncherComponent extends EnvironmentComponent {
    ...
    private int execGuestProgram() {
        ...
        envVars.put("PATH", winePath+"/bin:"+rootDir+"/usr/local/bin:"+rootDir+"/usr/bin");
    ...
    private void addBox64EnvVars(EnvVars envVars) {
        ...
        // GTA SA RenderWare & SA-MP Dynarec optimizations
        ...
        envVars.put("BOX64_ALLOWMISSINGLIBS", "1");
        envVars.put("MESA_EXTENSION_MAX_YEAR", "2005");
