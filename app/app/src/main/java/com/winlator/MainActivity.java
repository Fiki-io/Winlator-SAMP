...
public class MainActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (editInputControls) {
            ...
            int menuItemId = selectedMenuItemId > 0 ? selectedMenuItemId : R.id.menu_item_samp_hub;
    ...
    public void onBackPressed() {
        if (currentFragment != null && currentFragment.isVisible()) {
            ...
            else if (currentFragment instanceof com.winlator.samp.SampHubFragment || currentFragment instanceof ContainersFragment) {
                finish();
                return;
            }
        }

        showFragment(new com.winlator.samp.SampHubFragment());
    }
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
        ...
        switch (item.getItemId()) {
            case R.id.menu_item_samp_hub:
                showFragment(new com.winlator.samp.SampHubFragment());
                break;
            case R.id.menu_item_samp_settings:
                showFragment(new com.winlator.samp.SampSettingsFragment());
                break;
            ...
            case R.id.menu_item_logs:
                showFragment(new LogViewerFragment());
                break;
