...
public enum XKeycode {
    ...
    public static XKeycode fromChar(char c) {
        char lower = Character.toLowerCase(c);
        if (lower >= 'a' && lower <= 'z') {
            return XKeycode.valueOf("KEY_" + Character.toUpperCase(lower));
        }
        else if (c >= '0' && c <= '9') {
            return XKeycode.valueOf("KEY_" + c);
        }
        else if (c == ' ') return KEY_SPACE;
        else if (c == '/') return KEY_SLASH;
        else if (c == '.') return KEY_PERIOD;
        else if (c == ',') return KEY_COMMA;
        else if (c == '-') return KEY_MINUS;
        else if (c == '=') return KEY_EQUAL;
        else if (c == ';') return KEY_SEMICOLON;
        else if (c == '\'') return KEY_APOSTROPHE;
        else if (c == '\\') return KEY_BACKSLASH;
