...
public abstract class WineUtils {
    ...
    public static void applyGtaOptimizations(Container container) {
        ...
        try (WineRegistryEditor registryEditor = new WineRegistryEditor(userRegFile)) {
            // DLL Overrides for ASI loaders, CLEO, DirectX 9, audio & network
            registryEditor.setStringValue(dllOverridesKey, "d3d9", "native,builtin");
            registryEditor.setStringValue(dllOverridesKey, "dinput8", "native,builtin");
            registryEditor.setStringValue(dllOverridesKey, "dsound", "native,builtin");
            registryEditor.setStringValue(dllOverridesKey, "ws2_32", "builtin,native");
            registryEditor.setStringValue(dllOverridesKey, "vorbisfile", "native,builtin");
            registryEditor.setStringValue(dllOverridesKey, "vorbishooked", "native,builtin");
            registryEditor.setStringValue(dllOverridesKey, "eax", "native,builtin");

            // Direct3D 9 optimizations for RenderWare
            registryEditor.setStringValue(direct3DKey, "CSMT", "enabled");
            registryEditor.setStringValue(direct3DKey, "OffscreenRenderingMode", "fbo");
            registryEditor.setStringValue(direct3DKey, "StrictDrawOrdering", "disabled");
            registryEditor.setStringValue(direct3DKey, "CheckFloatConstants", "disabled");
            registryEditor.setStringValue(direct3DKey, "AlwaysOffscreen", "enabled");
            registryEditor.setStringValue(direct3DKey, "Multisampling", "disabled");
            registryEditor.setStringValue(direct3DKey, "VideoMemorySize", "512");
            registryEditor.setStringValue(direct3DKey, "UseGLSL", "enabled");
        }
    }
